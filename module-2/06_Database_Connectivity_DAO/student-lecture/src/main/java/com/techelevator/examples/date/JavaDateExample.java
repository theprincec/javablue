package com.techelevator.examples.date;
...
public class JavaDateExample {
	...
	/*
	 * Prior to Java 8 - only here as an example, don't copy this, use the
	 * Java 8 example below.
	 */
	...
	/*
	 * Example of Java 8's LocalDate - USE THIS EXAMPLE
	 */
