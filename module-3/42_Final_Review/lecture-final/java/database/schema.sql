...
CREATE TABLE purchases (
        ...
        constraint fk_purchses_user_id FOREIGN KEY (user_id) references users(user_id)
);
...
CREATE TABLE purchase_product (
        ...
        constraint fk_purhase_product_product_id FOREIGN KEY (product_id) references products(id),
        constraint fk_purchase_porduct_purchase_id FOREIGN KEY (purchase_id) references purchases(id),
