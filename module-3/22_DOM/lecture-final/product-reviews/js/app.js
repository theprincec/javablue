...
function displayReviews() {
  ...
  reviews.forEach( review => {
    ...
    // setAttribute('class') and classList.add() both can be used to add a starting css class
...
function addTitle(parent, title) {
  ...
  parent.insertAdjacentElement('beforeend', reviewTitle);
}
...
function addReview(parent, review) {
  const reviewFromUser = document.createElement('p');
  reviewFromUser.innerText = review;
  parent.insertAdjacentElement('beforeend', reviewFromUser);
