...
public class WoodenPencil {
	 ...
	 */
	// constants
	public static final double defaultLength = 8.0;			// default length
	public static final int defaultShape = 2;				// default shape
	public static final String defaultHardness = "HB";		// default hardness 
	public static final Color defaultColor = Color.YELLOW;	// default color
	public static final double defaultStubLength = 2.0;		// default stubLength
	public static final double defaultMaxDullness = 0.3;	// default maxDullness
	// adjustable/changeable
	private static double stubLength = defaultStubLength;	// when pencil is a "stub", in inches 
	...
	private int shape;			// 1=triangular, 2=hexagonal, 3=round
	private String hardness;	// "B", "HB", "F", "H", "2H"
	private Color color;		// exterior, not lead
	 ...
	 * Class variable set, note static modifier
	 * 
	 * @param maxDulness, must >= 0.0 and <= 1.0
	 */
